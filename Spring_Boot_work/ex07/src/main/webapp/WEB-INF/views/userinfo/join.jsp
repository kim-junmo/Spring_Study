        ...
        <div class="col">
          ...
          <div class="card-body">
              ...
              <label for="u_confirm_pwd" class="col-sm-2 col-form-label">U_Confirm_PWD</label>
                <div class="col-sm-4">
                  <input type="password" class="form-control" id="u_confirm_pwd" name="u_confirm_pwd" placeholder="U_Confirm_PWD">
              </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="sample2_postcode" name="u_zipcode" placeholder="U_ZIPCODE">
              </div>
              <div class="col-sm-4">
              ...
              <div class="form-group row">
                <label for="u_addrdetatil" class="col-sm-2 col-form-label">U_ADDRDETATIL</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="sample2_detailAddress" name="u_addrdetatil" placeholder="U_ADDRDETATIL">
